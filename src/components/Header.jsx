    ...
    <header>
        ...
        <nav >
            <ul className="list-header">
                ...
                <li><Link to="/article">Articulo</Link></li>
        ...
        {/* <section className='action-section'>
          <>
            <div
                ...
                onClick={handleClick}
            >
                <img src="https://freelogopng.com/images/all_img/1664302686valorant-icon-png.png" alt="Imagen" className="circle-image" />
            </div>
            {isOpen && (
                 ...
                 <ul className="list-profile">
                    <li>Opción 1</li>
                    <li>Opción 2</li>
                    <li onClick={handleList}>Log out</li>
                </ul>
